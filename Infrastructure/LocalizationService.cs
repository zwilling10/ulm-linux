...
namespace ULM.Infrastructure
{
    ...
    public static class LocalizationService
    {
        ...
        private static readonly Dictionary<Str, string> De = new()
        {
            ...
            [Str.Category_Advanced]              = "⚙️ Fortgeschrittene (Unabhängigkeit & Stabilität)",
            ...
            [Str.Db_DiscoverySearchFallback] = "🔍 Manuell bei DuckDuckGo suchen",
            ...
            // ── Linux-GUI (Phase A) ──
            [Str.Linux_Header_Subtitle]           = "USB-Stick einrichten · Linux-ISOs verwalten · Downloads überwachen",
            [Str.Linux_Header_Settings]           = "⚙ Einstellungen",
            [Str.Linux_Header_Help]               = "❓ Hilfe",
            [Str.Linux_Header_NotAvailableTooltip]= "Folgt in einer späteren Phase",
            [Str.Linux_Toolbar_TargetDrive]       = "ZIEL-USB-LAUFWERK",
            [Str.Linux_Toolbar_SecureBoot]        = "Secure Boot",
            [Str.Linux_Toolbar_FreeSpaceFormat]   = "Frei: {0}",
            [Str.Linux_Tab_IsoSelection]          = "ISO-Auswahl",
            [Str.Linux_Tab_Log]                   = "Protokoll",
            [Str.Linux_Tab_Status]                = "Status",
            [Str.Linux_Column_Distribution]       = "Linux-Distribution (Haken = Download)",
            [Str.Linux_Column_Local]              = "Lokal",
            [Str.Linux_Column_OnStick]            = "Auf dem Stick",
            [Str.Linux_Column_Current]            = "Aktuell",
            [Str.Linux_Log_Clear]                 = "Leeren",
            [Str.Linux_Status_CurrentOperation]   = "Aktueller Vorgang",
            [Str.Linux_Status_Idle]               = "Kein Vorgang aktiv.",
            [Str.Linux_Actions_Download]          = "⬇  Herunterladen",
            [Str.Linux_Actions_CheckUpdates]      = "↻  Updates prüfen",
            [Str.Linux_Actions_CheckUrls]         = "URLs prüfen",
            [Str.Linux_Actions_SearchIso]         = "ISO suchen",
            [Str.Linux_Actions_Database]          = "Datenbank",
            [Str.Linux_Actions_DbHealthCheck]     = "DB-Gesundheitscheck",
            [Str.Linux_Actions_CopyToStick]       = "Auf Stick kopieren",
            [Str.Linux_Actions_VerifyIntegrity]   = "Integrität prüfen",
            [Str.Linux_Actions_GitHubToken]       = "GitHub-Token",
            [Str.Linux_Actions_NotAvailableTooltip] = "Noch nicht auf Linux verfügbar",
            [Str.Linux_Ventoy_Install]            = "Ventoy einrichten",
            [Str.Linux_Ventoy_Update]             = "Ventoy aktualisieren",
            [Str.Linux_Ventoy_ConfirmInstall]     = "ACHTUNG: Alle Daten auf {0} ({1:F1} GB) werden gelöscht. Ventoy jetzt einrichten?",
            [Str.Linux_Ventoy_ConfirmUpdate]      = "Ventoy auf {0} ({1:F1} GB) aktualisieren?",
            [Str.Linux_Ventoy_ConfirmYes]         = "Ja, fortfahren",
            [Str.Linux_Ventoy_ConfirmCancel]      = "Abbrechen",
        ...
        private static readonly Dictionary<Str, string> En = new()
        {
            ...
            [Str.Category_Advanced]              = "⚙️ Advanced (Independence & Stability)",
            ...
            [Str.Db_DiscoverySearchFallback] = "🔍 Search manually on DuckDuckGo",
            ...
            // ── Linux GUI (Phase A) ──
            [Str.Linux_Header_Subtitle]           = "Set up USB stick · Manage Linux ISOs · Monitor downloads",
            [Str.Linux_Header_Settings]           = "⚙ Settings",
            [Str.Linux_Header_Help]               = "❓ Help",
            [Str.Linux_Header_NotAvailableTooltip]= "Coming in a later phase",
            [Str.Linux_Toolbar_TargetDrive]       = "TARGET USB DRIVE",
            [Str.Linux_Toolbar_SecureBoot]        = "Secure Boot",
            [Str.Linux_Toolbar_FreeSpaceFormat]   = "Free: {0}",
            [Str.Linux_Tab_IsoSelection]          = "ISO Selection",
            [Str.Linux_Tab_Log]                   = "Log",
            [Str.Linux_Tab_Status]                = "Status",
            [Str.Linux_Column_Distribution]       = "Linux Distribution (check = download)",
            [Str.Linux_Column_Local]              = "Local",
            [Str.Linux_Column_OnStick]            = "On Stick",
            [Str.Linux_Column_Current]            = "Current",
            [Str.Linux_Log_Clear]                 = "Clear",
            [Str.Linux_Status_CurrentOperation]   = "Current operation",
            [Str.Linux_Status_Idle]               = "No operation running.",
            [Str.Linux_Actions_Download]          = "⬇  Download",
            [Str.Linux_Actions_CheckUpdates]      = "↻  Check updates",
            [Str.Linux_Actions_CheckUrls]         = "Check URLs",
            [Str.Linux_Actions_SearchIso]         = "Search ISO",
            [Str.Linux_Actions_Database]          = "Database",
            [Str.Linux_Actions_DbHealthCheck]     = "DB health check",
            [Str.Linux_Actions_CopyToStick]       = "Copy to stick",
            [Str.Linux_Actions_VerifyIntegrity]   = "Verify integrity",
            [Str.Linux_Actions_GitHubToken]       = "GitHub token",
            [Str.Linux_Actions_NotAvailableTooltip] = "Not yet available on Linux",
            [Str.Linux_Ventoy_Install]            = "Set up Ventoy",
            [Str.Linux_Ventoy_Update]             = "Update Ventoy",
            [Str.Linux_Ventoy_ConfirmInstall]     = "WARNING: All data on {0} ({1:F1} GB) will be erased. Set up Ventoy now?",
            [Str.Linux_Ventoy_ConfirmUpdate]      = "Update Ventoy on {0} ({1:F1} GB)?",
            [Str.Linux_Ventoy_ConfirmYes]         = "Yes, proceed",
            [Str.Linux_Ventoy_ConfirmCancel]      = "Cancel",
