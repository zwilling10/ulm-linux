namespace ULM.Infrastructure
{
    ...
    public enum Str
    {
        ...
        // ── Linux-GUI (Phase A: MainWindow-Optik/-Struktur an Windows angeglichen) ──
        Linux_Header_Subtitle,
        Linux_Header_Settings,
        Linux_Header_Help,
        Linux_Header_NotAvailableTooltip,
        Linux_Toolbar_TargetDrive,
        Linux_Toolbar_SecureBoot,
        Linux_Toolbar_FreeSpaceFormat,
        Linux_Tab_IsoSelection,
        Linux_Tab_Log,
        Linux_Tab_Status,
        Linux_Column_Distribution,
        Linux_Column_Local,
        Linux_Column_OnStick,
        Linux_Column_Current,
        Linux_Log_Clear,
        Linux_Status_CurrentOperation,
        Linux_Status_Idle,
        Linux_Actions_Download,
        Linux_Actions_CheckUpdates,
        Linux_Actions_CheckUrls,
        Linux_Actions_SearchIso,
        Linux_Actions_Database,
        Linux_Actions_DbHealthCheck,
        Linux_Actions_CopyToStick,
        Linux_Actions_VerifyIntegrity,
        Linux_Actions_GitHubToken,
        Linux_Actions_NotAvailableTooltip,
        Linux_Ventoy_Install,
        Linux_Ventoy_Update,
        Linux_Ventoy_ConfirmInstall,
        Linux_Ventoy_ConfirmUpdate,
        Linux_Ventoy_ConfirmYes,
        Linux_Ventoy_ConfirmCancel,
