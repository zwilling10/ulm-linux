...
public class IsoEntryNormalizeSourceForgeUrlTests
{
    ...
    [InlineData(
        "https://downloads.sourceforge.net/project/pulsaros-inled/pulsaros-0.4-beta-bittenfruit-arch-grub-0.4-beta-bittenfruit.iso",
        "https://master.dl.sourceforge.net/project/pulsaros-inled/pulsaros-0.4-beta-bittenfruit-arch-grub-0.4-beta-bittenfruit.iso?viasf=1")]
    ...
    [Theory]
    // "sourceforge.net/projects/<name>/files/<datei>.iso/download"-Muster: wird inzwischen
    // ebenfalls auf die stabile master-URL normalisiert (siehe SourceForgeFilesDownload).
    [InlineData(
        "https://sourceforge.net/projects/equestria-os/files/equestria-os-2026.07.08-x86_64.iso/download",
        "https://master.dl.sourceforge.net/project/equestria-os/equestria-os-2026.07.08-x86_64.iso?viasf=1")]
    public void NormalizeSourceForgeUrl_RewritesFilesDownloadToMaster(string input, string expected)
        => Assert.Equal(expected, IsoEntry.NormalizeSourceForgeUrl(input));
    ...
    [Fact]
    public void AllDownloadUrls_DownloadsSourceForgeProject_FansOutsMirrors()
    {
        var entry = new IsoEntry
        {
